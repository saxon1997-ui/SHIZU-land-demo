 window.Vallage = {
    ...
    updateData: function(choice) {        
        switch(choice) {
            ...
            case 'z2211121112':
            case 'z22111211111':
                ItemSystem.addItem('邪之印记');
                break;
            case 'z2211141111':
                ItemSystem.addItem('红宝石');
                ItemSystem.addItem('金色符文匕首');
                break;
        }
        updateCharacterPanel();
    }
