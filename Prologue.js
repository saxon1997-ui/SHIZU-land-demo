    ...
    handleChoice: function(choice) {
        ...
        if (choice === 'c1') {
            ...
            content.innerHTML = `
                ...
                <p>你快步上前，你发现了一块黄色宝石</p>
                <p>你将宝石放入你的上衣口袋</p>
                <p>你这才惊讶地发现，你口袋中还有一枚同样大小的绿色宝石</p>
                <p>但疲惫又寒冷的你来不及多思考</p>
            ...
            content.innerHTML = `
                ...
                <button class="choice-btn" onclick="handleChoice('c111222')">你的第六感告诉你，你可以捏碎黄色宝石</button>
    ...
    updateData: function(choice) {        
        switch(choice) {
            ...
            case 'c112': 
                ...
                break;
            case 'c1112': 
                characterData.inventory.push('黄宝石');
                break;
            case 'c11111': 
            case 'c11114':
                characterData.hp += 30;
            ...
            case 'c1111111': 
            case 'c1111112':
                characterData.inventory.push('白纸契约','指针');
            ...
            case 'c111141': 
            case 'c112111': 
                characterData.inventory.push('鹿皮','打火石');
                break;
            case 'c1111122':
            case 'c1111121':
            case 'c1112211':
                characterData.inventory.push('黑纸契约','指针');
                characterData.power += 10;
                characterData.hp += 50;
                break;
        }
